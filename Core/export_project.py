...
def export_project(title: str, composer: str, illustrator: str, music_file: str, illustration_file: str, charts: list, dir_path: str = '') -> dict:
    """
    导出项目
    返回：文件名-文件路径 dict
    """
    ...
    for chart_info in charts:
        ...
        project_data = read_json(os.path.join(dir_path, chart_info.pop('path')))
