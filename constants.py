...
COMMAND_PARAM_TYPE = {
    ...
    CMD_NOTE_TRACK_LINEAR: PT_LINEAR,
    CMD_NOTE_TRACK_SINE: PT_SINE,
    CMD_LINE_ALPHA_LINEAR: PT_LINEAR,
    CMD_LINE_ALPHA_SINE: PT_SINE,
    CMD_LINE_POS_LINEAR: PT_LINEAR,
    CMD_LINE_POS_SINE: PT_SINE,
    CMD_LINE_PLAY_POS: PT_LINEAR
}
